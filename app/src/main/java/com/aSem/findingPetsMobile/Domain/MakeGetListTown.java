...
public class MakeGetListTown extends UseCase {
    @Inject
    public SqliteAccess sqliteAccess;
    @Inject
    MakeGetListTown(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, SqliteAccess sqliteAccess) {
        super(threadExecutor, postExecutionThread);
        this.sqliteAccess=sqliteAccess;
    }
    @Override
    Observable buildUseCaseObservable(Object o) {
        return sqliteAccess.getListTown();
    }
}

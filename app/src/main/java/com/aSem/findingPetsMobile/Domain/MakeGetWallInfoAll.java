...
public class MakeGetWallInfoAll extends UseCase {
    @Inject
    ...
    @Inject
    MakeGetWallInfoAll(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, SqliteAccess sqliteAccess) {
        super(threadExecutor, postExecutionThread);
        this.sqliteAccess=sqliteAccess;
    }
    public void setParam(String offset, String limit, String searchQry){
        this.offset = offset;
        this.limit = limit;
    ...
    Observable buildUseCaseObservable(Object o) {
        return sqliteAccess.getWallInfoAll(offset,limit,searchQry);
    }
}

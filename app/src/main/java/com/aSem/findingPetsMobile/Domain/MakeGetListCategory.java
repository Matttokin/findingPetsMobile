...
public class MakeGetListCategory extends UseCase {
    @Inject
    public SqliteAccess sqliteAccess;
    @Inject
    MakeGetListCategory(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread, SqliteAccess sqliteAccess) {
        super(threadExecutor, postExecutionThread);
        this.sqliteAccess=sqliteAccess;
    }
    @Override
    Observable buildUseCaseObservable(Object o) {
        return sqliteAccess.getListCategory();
    }
}

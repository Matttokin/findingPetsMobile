...
public class ShowOnMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String latitude = arguments.get("latitude").toString();
        String longitude = arguments.get("longitude").toString();
        String radius = arguments.get("radius").toString();
        String title = arguments.get("title").toString();


        LatLng pos = new LatLng(Double.valueOf(latitude), Double.valueOf(longitude));
